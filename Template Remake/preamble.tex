...
% \usepackage{newtxtext, newtxmath} % for text and math fonts DONT USE else toc goes away
...
\titlecontents{chapter}[6.7pc]
{
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		\pgftext[left, x = -3.5cm, y = 0.18cm]{\color{white}\Large\sc\bfseries Chapter\ \thecontentslabel};
	\end{tikzpicture}
    \color{TOC_COLOR1}\large\sc\bfseries}
{}
{}
{
    \;\titlerule\;\large\sc\bfseries Page \thecontentspage\begin{tikzpicture}[remember picture, overlay]
...
\renewcommand{\tableofcontents}
{
	\chapter*{
	  \vspace*{-20\p@}
	  \begin{tikzpicture}[remember picture, overlay]
		  \pgftext[right, x = 15cm, y = 0.2cm]{\color{TOC_COLOR2}\Huge\sc\bfseries \contentsname};
